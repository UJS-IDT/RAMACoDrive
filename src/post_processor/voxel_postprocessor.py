...
from post_processor.base_postprocessor import BasePostprocessor
from post_processor.box import box_utils
from post_processor.box.box_overlaps import bbox_overlaps
...
class VoxelPostprocessor(BasePostprocessor):
    ...
    def post_process(self, output_dict, transformation_matrix, anchor_box):
        """
