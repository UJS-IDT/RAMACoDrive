...
from models.fuse_modules.multi_scale_att_fusion import MultiAttFusion


class PointPillarBaselineIntermediate(nn.Module):
    def __init__(self, args, max_cav_num):
        super(PointPillarBaselineIntermediate, self).__init__()
        ...
        self.fuse_network = MultiAttFusion(input_channels=256, pool_scales=(1,2,4), use_proj=True)
    ...
    def forward(self, data_dict, calculate_flag=False):
        ...
        fused_feature = self.fuse_network(spatial_features_2d, record_len)
