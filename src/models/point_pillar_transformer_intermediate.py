...
from models.fuse_modules.v2xvit_basic import V2XTransformer


class PointPillarTransformerIntermediate(nn.Module):
    def __init__(self, args, max_cav_num):
        super(PointPillarTransformerIntermediate, self).__init__()
