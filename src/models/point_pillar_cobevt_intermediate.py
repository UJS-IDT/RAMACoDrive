...
#from models.fuse_modules.f_cooper_fuse import SpatialFusion
from models.fuse_modules.swap_fusion_modules import SwapFusionEncoder
from models.fuse_modules.fuse_utils import regroup


class PointPillarCOBEVTIntermediate(nn.Module):
    def __init__(self, args, max_cav_num):
        super(PointPillarCOBEVTIntermediate, self).__init__()
