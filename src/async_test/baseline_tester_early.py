...
class Tester(multiprocessing.Process):
                ...
                try:
                    ...
                    if self.ego_flag:
                        ...
                        for scene_id in range(len(self.ego_data)):
                            ...
                            cav_num = len(projected_lidar_stack)
    ...
    def get_item_single_car(self, selected_cav_base, ego_pose):
        ...
        projected_lidar, processed_flag = self.get_processed_lidar(selected_cav_base["lidar_data"], ego_pose, selected_cav_base["lidar_pose"])
        if processed_flag:
